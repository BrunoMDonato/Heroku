...
from Blog.models import Posts, Comentarios, Avatar
...
def Inicio(request):
    ...
    return render (request, 'Blog/index.html', {'posts':titulos, 'avatar' : avats})
...
class PostDetalle ( LoginRequiredMixin, DetailView):
    ...
    model = Posts
    template_name = "Blog/posts_detalle.html"
...
def login_request(request):
    ...
    if request.method== 'POST':
        ...
        if formulario.is_valid():
            ...
            return render (request, 'Blog/login.html', {'errors': ['Datos incorrectos'], 'bool':True})
...
def register_request(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render (request, 'Blog/register.html', {'var' : succes})
        else:

            return render(request, 'Blog/register.html', {'errors':['Datos incorrectos: La contraseña debe ser mayor a 8 caracteres. Al menos una mayuscula. Evite similitudes con el nombre de usuario o correo'], 'posts':titulos})
...
def contraseña_correct(request):
    return render (request, 'Blog/cont_cambio_correct.html')
...
class EditarAvatar(CreateView):
    ...
    model = Avatar
    template_name = 'Blog/editar_avatar.html'
    success_url= reverse_lazy ('Inicio')
    fields= '__all__'
